...
#
# usage: aws-stacks [--name stack-name-pattern] [--output output-key-pattern ] [--outputs] [--exports]
#
# If --name with a simple pattern is given then limit stacks to those
# whose stack name contains the specified simple pattern (case-insensitive).
#
