...
class AwsFunctions(AwsContext):
    ...
    def get_opensearch_endpoint(self, aws_credentials_name: str):
        ...
        # TODO/QUESTION: If this value is being generated by the datastore stack provisioning
        # within the 4dn-cloud-infra code base, why couldn't we use the same code to get
